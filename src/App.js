...
import {
  ...
  VerdantKinBanner, ElectroneumLogo, AetherScionsBanner, VerdantQueenBanner, EtnClubLogo, EvgBanner, TelegramLogo
      ...
      {nfts.map((slot, i) => (
        ...
        >
          ...
          >
            {[...ownedNFTs]
              .sort((a, b) => {
                const aPriority = backgroundPriority[a?.background] ?? 999;
                const bPriority = backgroundPriority[b?.background] ?? 999;
